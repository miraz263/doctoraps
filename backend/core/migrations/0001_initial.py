# Generated by Django 4.2.19 on 2025-09-29 19:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('doctor', 'Doctor'), ('reception', 'Reception'), ('patient', 'Patient'), ('admin', 'Admin')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('booked', 'Booked'), ('confirmed', 'Confirmed'), ('rejected', 'Rejected'), ('completed', 'Completed')], default='booked', max_length=20)),
                ('consultation_type', models.CharField(choices=[('video', 'Video'), ('audio', 'Audio'), ('chat', 'Chat')], default='video', max_length=20)),
